-- Pedro Moreno Gullón, Samuel Leyton Rojas y Oscar García Delgado
...
CREATE OR REPLACE FUNCTION EDAD(fecha date)
RETURN NUMBER IS
edad1 number;
BEGIN
edad1:=trunc((sysdate-fecha)/365.25);
return edad1;
END;
...
-- Procedimiento para imprimir datos cliente por pantalla
