...
VALUES ('Oscar', 'García', 'Delgado', TO_DATE('1990-06-15', 'YYYY-MM-DD'), '654987321', 'oscar.garcia@gmail.com', '28002', 'Madrid', 'Madrid', 'España', 'Avenida', 'Castellana');

-- 4. Insertar usuarios
INSERT INTO usuario_cliente (nombre_usuario, contrasena, correo_electronico, cliente_id)
VALUES ('luciaPG', '1234secure', 'oscar.garcia@gmail.com', 1);
