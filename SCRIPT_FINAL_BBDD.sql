...
-- 9. Insertar cita
INSERT INTO cita (donacion, correo_electronico, estado, fecha_cita, hora_cita, cliente_id, perro_id, protectora_id)
VALUES (30.00, 'lucia.perez@gmail.com', 'Confirmada', TO_DATE('2025-05-15', 'YYYY-MM-DD'), '10:00', 1, 1, 1);

-- 10. Insertar notificación (usando el procedimiento)
BEGIN
    enviar_notificacion(
        nueva_cita_noti => 'Sí',
        cancelar_cita_noti => 'No',
        nueva_adopcion_noti => 'Sí',
